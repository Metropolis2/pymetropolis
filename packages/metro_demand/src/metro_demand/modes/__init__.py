...
from metro_demand.modes.car_driver import CAR_DRIVER_DISTANCES_STEP
from metro_demand.modes.public_transit import PUBLIC_TRANSIT_TRAVEL_TIMES_FROM_ROAD_DISTANCES_STEP

from .car_driver import CAR_DRIVER_PREFERENCES_STEP, CAR_DRIVER_TABLE
from .files import (
...
from .public_transit import PUBLIC_TRANSIT_PREFERENCES_STEP, PUBLIC_TRANSIT_TABLE
