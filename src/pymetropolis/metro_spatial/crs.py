...
class GeoStep(Step):
    crs = CustomParameter(
        ...
        note=(
            "You can use the epsg.io website to find a projected coordinate system that is adapted "
            "for your study area. It is strongly recommended that the unit of measure is meter. "
            "If you use a coordinate system for an area of use that is not adapted or with an "
