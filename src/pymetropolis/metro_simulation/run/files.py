...
ITERATION_RESULTS_SCHEMA = [
    ...
    Column(
        ...
        MetroDataType.FLOAT,
        description=(
            "Mean departure time of the first trip, over agents (number of seconds since midnight)."
        ),
    ),
    Column(
    ...
    Column(
        ...
        MetroDataType.FLOAT,
        description=(
            "Mean arrival time of the last trip, over agents (in number of seconds since midnight)."
        ),
    ),
    Column(
    ...
    Column(
        ...
        MetroDataType.FLOAT,
        description=(
            "Standard-deviation of delay at entry bottlenecks, over all road trips (in seconds)."
        ),
    ),
    Column(
    ...
    Column(
        ...
        MetroDataType.FLOAT,
        description=(
            "Mean free-flow travel time of the selected route, over all road trips (in seconds)."
        ),
    ),
    Column(
    ...
    Column(
        ...
        MetroDataType.FLOAT,
        description=(
            "Minimum free-flow travel time of the selected route, over all road trips (in seconds)."
        ),
    ),
    Column(
        ...
        MetroDataType.FLOAT,
        description=(
            "Maximum free-flow travel time of the selected route, over all road trips (in seconds)."
        ),
    ),
    Column(
    ...
    Column(
        ...
        MetroDataType.FLOAT,
        description=(
            "Minimum travel time of the fastest free-flow route, over all road trips (in seconds)."
        ),
    ),
    Column(
        ...
        MetroDataType.FLOAT,
        description=(
            "Maximum travel time of the fastest free-flow route, over all road trips (in seconds)."
        ),
    ),
    Column(
    ...
    Column(
        ...
        MetroDataType.FLOAT,
        description=(
            "Standard-deviation of length of the selected route, over all road trips (in meters)."
        ),
    ),
    Column(
...
TRIP_RESULTS_SCHEMA = [
    ...
    Column(
        ...
        MetroDataType.FLOAT,
        description=(
            "Length of the route taken that was not taken during the previous iteration, in meters."
        ),
        nullable=True,
    ),
    Column(
...
AGENT_RESULTS_SCHEMA = [
    Column("agent_id", MetroDataType.ID, description="Identifier of the agent.", nullable=False),
    Column(
        "selected_alt_id",
        MetroDataType.ID,
    ...
    Column(
        "utility", MetroDataType.FLOAT, description="Realized utility of the agent.", nullable=False
    ),
    Column(
...
class MetroIterationResultsFile(MetroDataFrameFile):
    ...
    schema = ITERATION_RESULTS_SCHEMA
...
class MetroExAnteTripResultsFile(MetroDataFrameFile):
    path = "run/ex_ante_output/trip_results.parquet"
    description = "Trip-level results from the Metropolis-Core simulation."
    schema = TRIP_RESULTS_SCHEMA


class MetroExAnteAgentResultsFile(MetroDataFrameFile):
    path = "run/ex_ante_output/agent_results.parquet"
    description = "Agent-level results from the Metropolis-Core Simulation."
    schema = AGENT_RESULTS_SCHEMA


class MetroExAnteRouteResultsFile(MetroDataFrameFile):
    path = "run/ex_ante_output/route_results.parquet"
    description = "Edge-level results for road trips from the Metropolis-Core Simulation."
    schema = ROUTE_RESULTS_SCHEMA


class MetroExAnteSimulatedTravelTimeFunctionsFile(MetroDataFrameFile):
    path = "run/ex_ante_output/net_cond_sim_edge_ttfs.parquet"
    description = (
        "Simulated travel time functions of the road-network edges for the last iteration, "
        "represented as a list of breakpoints."
    )
...
class MetroExAnteExpectedTravelTimeFunctionsFile(MetroDataFrameFile):
    path = "run/ex_ante_output/net_cond_exp_edge_ttfs.parquet"
    description = (
        "Expected travel time functions of the road-network edges for the last iteration, "
        "represented as a list of breakpoints."
    )
...
class MetroExAnteNextExpectedTravelTimeFunctionsFile(MetroDataFrameFile):
    path = "run/ex_ante_output/net_cond_next_exp_edge_ttfs.parquet"
    description = (
        "Expected travel time functions of the road-network edges for the next iteration, "
        "represented as a list of breakpoints."
    )
