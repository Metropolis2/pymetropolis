...
class MetroAgentsPopulationFile(MetroDataFrameFile, PopulationFile):
    path = "demand/{population}/metro_input/agents.parquet"
    description = "Simulated agents in the population, ready for import to Metropolis-Core."
    schema = [
        Column(
            "agent_id",
            MetroDataType.ID,
...
class MetroAlternativesPopulationFile(MetroDataFrameFile, PopulationFile):
    path = "demand/{population}/metro_input/alts.parquet"
    description = "Simulated alternatives in the population, ready for import to Metropolis-Core."
    schema = [
        Column(
...
class MetroTripsPopulationFile(MetroDataFrameFile, PopulationFile):
    path = "demand/{population}/metro_input/trips.parquet"
    description = "Simulated trips in the population, ready for import to Metropolis-Core."
    schema = [
        Column(
            "agent_id", MetroDataType.ID, description="Identifier of the agent.", nullable=False
        ),
